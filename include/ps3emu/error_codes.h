...
#define CELL_ERROR_BASE_SYSUTIL_GAMEDATA 0x8002B600
...
#define CELL_AUDIO_ERROR_EVENT_QUEUE        (CELL_ERROR_BASE_AUDIO | 0x09)
#define CELL_AUDIO_ERROR_TAG_NOT_FOUND     (CELL_ERROR_BASE_AUDIO | 0x0A)
